...
class Thovex(Car):
    ...
    def needs_service(self):
        try:
            ...
            # Convert self.current_mileage to an integer
            current_mileage_int = int(self.current_mileage)

            needs_service = self.engine.needs_service() or current_mileage_int > service_threshold_mileage
